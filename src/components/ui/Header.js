                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            ...
                            to="/usuarios" activeClassName ="active" exact>
                                Usuarios
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" aria-current="page" 
                            to="/marcas" activeClassName ="active" exact>
                                Marcas
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" aria-current="page" 
                            to="/estados" activeClassName ="active" exact>
                                Estados
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" aria-current="page" 
                            to="/tipos" activeClassName ="active" exact>
                                Tipos
                            </NavLink>
                        </li>
